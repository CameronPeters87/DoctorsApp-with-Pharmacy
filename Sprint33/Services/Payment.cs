...
namespace Sprint33.Services
{
    public class Payment : IPayment
    {
        ...
        public string ToUrlEncodedString(Dictionary<string, string> request)
        {
            ...
            {
                //For Example from debugging "PAYGATE_ID=10011072130&REFERENCE=%2345846&AMOUNT=5000&CURRENCY=ZAR&RETURN_URL=http%3a%2f%2flocalhost%3a62919%2fpay%2fcompletepayment&TRANSACTION_DATE=2020-04-19+21%3a06%3a48&LOCALE=en-za&COUNTRY=ZAF&EMAIL=21816204%40dut4life.ac.za&CHECKSUM=4e309d8be4abeac2f4369133e25a6492"
                builder.Append("&");
                builder.Append(key);
                builder.Append("=");
        ...
        public bool AddTransaction(Dictionary<string, string> request, string payRequestId)
        {
            try
            {
                ...
                {
                    //All values available at that moment and are send to PAYGATE, and PAYGATE returns transaction status
                    DATE = DateTime.Now,
